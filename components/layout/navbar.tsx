...
<div>
  ...
  <nav className="fixed inset-0 z-20 hidden w-full bg-white px-5 py-16 lg:hidden">
    <ul className="grid divide-y divide-gray-200">
      <li className="py-3">
        <a className="flex w-full font-semibold capitalize" href="/customers">
          Features
        </a>
      </li>
      <li className="py-3">
      ...
      <li className="py-3">
        <a className="flex w-full font-semibold capitalize" href="/enterprise">
          Enterprise
        </a>
      </li>
      <li className="py-3">
        <a className="flex w-full font-semibold capitalize" href="/blog">
          Blog
        </a>
      </li>
      <li className="py-3">
        <a className="flex w-full font-semibold capitalize" href="/changelog">
          Changelog
        </a>
      </li>
      <li className="py-3">
      ...
      <div className="flex h-14 items-center justify-between">
        ...
        <div className="hidden lg:block">
          <a
            ...
            href="https://app.mcxleague.com/login"
          >
            Log in
          </a>
          <a
            ...
            href="https://app.mcxleague.com/register"
          >
            Sign Up
          </a>
        </div>
